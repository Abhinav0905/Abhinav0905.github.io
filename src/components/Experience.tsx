...
const experiences = [
  {
    ...
    description: [
      'Developed and deployed AI-driven automation solutions using Python and FastAPI',
      'Designed and integrated FastAPI to streamline connections with ServiceNow, reducing process execution times by 40%',
      'Built new FastAPI endpoints to centralize on-call team information and handle diverse user queries',
      'Conducted performance comparisons between Python-based API and legacy Java REST API'
    ]
  },
  {
    title: 'Tech Lead – Business Analyst & Data',
...
const skills = [
  ...
  },
  {
    ...
    items: ['Data Analysis', 'Dashboard Development', 'Data Governance', 'Data Quality Assurance', 'Process Mapping', 'Agile', 'SDLC', 'Jira', 'Git']
  }
];
