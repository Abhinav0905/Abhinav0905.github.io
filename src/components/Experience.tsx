const experiences = [
  {
    ...
    description: [
      'Product Development - Employee Productivity Platform: Led end-to-end development of an internal GenAI Q&A chatbot on the Employee Productivity Platform, leveraging Azure OpenAI Service (GPT-4) for query intent detection, OpenAI GPT-3.5-turbo and GPT-4 APIs for automated ticket resolution, and Pinecone- & Faiss-based RAG for knowledge search. Architected and maintained five Python microservices for this platform—driving <span style="font-weight: bold; color: black;">65% adoption in 2 months</span> and cutting Mean Time to Resolution by <span style="font-weight: bold; color: black;">45%</span>.',
      'Engineering Excellence: Led an effort to increase innovation agility in software development by modernizing the java legacy codebases into a single Python/FastAPI platform—decommissioned <span style="font-weight: bold; color: black;">three Java VMs</span>. Modernized the CI pipeline to achieve <span style="font-weight: bold; color: black;">40% faster</span> build times, implemented automated monitoring, and migrated employee data-pipeline daemons to Temporal-based workflows orchestration—eliminating <span style="font-weight: bold; color: black;">95% of failures</span>, reclaiming <span style="font-weight: bold; color: black;">eight engineer-hours per week</span>, and boosting pipeline reliability to <span style="font-weight: bold; color: black;">99.9% uptime</span>.',
      'AI based Contract Finder Feature: Designed and implemented the Contract Finder feature in internal chatbot, leveraging GenAI and LLM-based query intent detection to enable secure, alias-restricted contract data retrieval across Salesforce and Dynamics platforms. Integrated Databricks SQL and Cosmos DB for dynamic access control and real-time search. Reduced manual lookup time by <span style="font-weight: bold; color: black;">833+ hours annually</span>, saving <span style="font-weight: bold; color: black;">$125K+</span> in productivity.'
    ]
  },
  {
